...
<div style="font-family:Arial,Helvetica,sans-serif;max-width:620px;margin:0 auto;background:#f1f5f9;padding:20px 16px;">
  <div style="background:#0a1628;padding:36px 28px 32px;border-radius:12px 12px 0 0;text-align:center;">
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto 18px;"><tr><td width="68" height="68" align="center" valign="middle" style="width:68px;height:68px;background:#0a1628;border:6px solid #ffffff;border-radius:14px;color:#4097fd;font-family:Georgia,'Times New Roman',serif;font-size:44px;font-weight:900;line-height:68px;">V</td></tr></table>
