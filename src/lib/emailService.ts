...
<div style="font-family:Arial,Helvetica,sans-serif;max-width:620px;margin:0 auto;background:#f1f5f9;padding:20px 16px;">
  <div style="background:#0a1628;padding:36px 28px 32px;border-radius:12px 12px 0 0;text-align:center;">
    <img src="https://raw.githubusercontent.com/DoctorStrange95/vyasa-health-os/1e05031544c05dda941c196d63129831490ee974/public/email-assets/vyasa-email-logo-v1.jpg" width="92" height="92" alt="Vyasa" style="display:block;width:92px;height:92px;margin:0 auto 18px;border:6px solid #ffffff;border-radius:16px;box-sizing:border-box;background:#000000;" />
